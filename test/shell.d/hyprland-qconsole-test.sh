...
assert(current().on_created_empty:find("omarchy%-launch%-terminal"), "console is seeded with a terminal")
...
assert(final.on_created_empty:find("omarchy%-launch%-terminal"), "refitting keeps the console seeded")
